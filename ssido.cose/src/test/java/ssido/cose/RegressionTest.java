...
import ssido.cose.Encrypt0Message;
import ssido.cose.CounterSign1;
import ssido.cose.CounterSign;
import ssido.cose.Sign1Message;
import ssido.cose.HeaderKeys;
import ssido.cose.MAC0Message;
import ssido.cose.MACMessage;
import ssido.cose.SignMessage;
import ssido.cose.KeyKeys;
import ssido.cose.Attribute;
import ssido.cose.Recipient;
import ssido.cose.Message;
import ssido.cose.Signer;
import ssido.cose.AlgorithmID;
import ssido.cose.MessageTag;
import ssido.cose.EncryptMessage;
import org.junit.*;
...
public class RegressionTest extends TestBase {
    ...
    public void ProcessDirectory() {
        ...
        CFails = 0;
        String dir = Paths.get("./src/test/resources").toAbsolutePath().toString();
    ...
    public void ProcessFile(String test) {
        ...
        try {
            ...
            if (e.getMessage().equals("Unsupported key size") ||  e.getMessage().equals("Unsupported Algorithm")) {
    ...
    static CBORObject HeaderMap(CBORObject obj) {
     ...
     public boolean HasFailMarker(CBORObject cn) {
        ...
        return cnFail != null && cnFail.AsBoolean();
    }
